        ...
        <div className="max-w-md w-full space-y-8 text-center">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Oops! It seems our magic wand is experiencing some technical difficulties.
            </p>
            <p className="text-md text-gray-500 dark:text-gray-400">
              We're working on fixing the issue. Please try again later or contact our support team if the problem persists.
            </p>
          </div>
          <button onClick={()=>navigate('/')} className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors">
